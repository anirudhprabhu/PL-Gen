...
class Model(object):
    ...
    DATASET_FOLDER = os.path.join(os.path.dirname(os.path.abspath(__file__)), "pl_dataset")
    ...
    def get_dataset():
        ...
        all_file_name = np.array([f for f in all_file if f.find(".pl") != -1])
        ...
        # Convert the string into a list of integer
        vocab = set(content)
